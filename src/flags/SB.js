  ...
  return (
    ...
    >
      ...
      >
        <g id="SB_svg_SB">
          <rect
            id="SB_svg_FlagBackground"
            fill="url(#SB_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          />
          <polygon
            id="SB_svg_Rectangle-253"
            fill="url(#SB_svg_linearGradient-3)"
            points="0.000237781813 -0.00266538434 21.0002378 -0.00266538434 0.000237781813 14.9973346"
          />
          <polygon
            id="SB_svg_Rectangle-253"
            fill="url(#SB_svg_linearGradient-4)"
            transform="translate(10.500238, 7.497335) scale(-1, 1) translate(-10.500238, -7.497335) "
            points="0.000237781813 -0.00266538434 21.0002378 14.9973346 0.000237781813 14.9973346"
          />
          <rect
            id="SB_svg_Rectangle-2"
            fill="url(#SB_svg_linearGradient-5)"
            x={-3.99976222}
            y={6.49733462}
            width={29}
            height={2}
