...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BZ_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BZ_svg_prefix__b">
          <stop stopColor="#094995" offset="0%" />
          <stop stopColor="#074185" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BZ_svg_prefix__c">
          <stop stopColor="#D5182F" offset="0%" />
          <stop stopColor="#CC162C" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#BZ_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#BZ_svg_prefix__b)" d="M0 2h21v11H0z" />
        <path fill="url(#BZ_svg_prefix__c)" d="M0 0h21v2H0zM0 13h21v2H0z" />
        <circle fill="url(#BZ_svg_prefix__a)" cx={10.5} cy={7.5} r={4.5} />
        <path
