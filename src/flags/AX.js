  ...
  return (
    ...
    >
      ...
      >
        <g id="AX_svg_AX">
          <rect
            id="AX_svg_FlagBackground"
            fill="url(#AX_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="AX_svg_Mask-Copy"
            fill="url(#AX_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <polygon
            id="AX_svg_Rectangle-2"
            fill="url(#AX_svg_linearGradient-3)"
            points="0 9 6 9 6 15 9 15 9 9 21 9 21 6 9 6 9 0 6 0 6 6 0 6"
          />
          <polygon
            id="AX_svg_Rectangle-2"
            fill="url(#AX_svg_linearGradient-4)"
