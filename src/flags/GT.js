  ...
  return (
    ...
    >
      ...
      >
        <g id="GT_svg_GT">
          <rect
            id="GT_svg_FlagBackground"
            fill="url(#GT_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="GT_svg_Mask"
            fill="url(#GT_svg_linearGradient-2)"
            x={10}
            y={0}
            width={11}
            height={15}
          ...
          <path
            ...
            fillRule="nonzero"
          />
          <circle id="GT_svg_Oval-5" fill="#DCC26D" cx={10.5} cy={7} r={1} />
        </g>
      </g>
    </svg>
  );
