  ...
  return (
    ...
    >
      ...
      >
        <g id="AL_svg_AL">
          <rect
            id="AL_svg_FlagBackground"
            fill="url(#AL_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="AL_svg_Mask"
            fill="url(#AL_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
