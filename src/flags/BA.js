...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BA_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BA_svg_prefix__b">
          <stop stopColor="#0B36B2" offset="0%" />
          <stop stopColor="#042993" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="BA_svg_prefix__c">
          <stop stopColor="#FFD045" offset="0%" />
          <stop stopColor="#FECA2F" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#BA_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#BA_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path fill="url(#BA_svg_prefix__c)" d="M17 15V0H6.5z" />
        <path
          fill="url(#BA_svg_prefix__a)"
