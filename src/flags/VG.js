  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#VG_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#VG_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
          d="M13 7.5V5c0-.553.444-1 1-1h3c.552 0 1 .441 1 1v2.5c0 2.5-2.5 3.5-2.5 3.5S13 10 13 7.5z"
          fill="url(#VG_svg_prefix__c)"
        />
        <path
          ...
          fill="url(#VG_svg_prefix__d)"
        />
        <ellipse
          fill="url(#VG_svg_prefix__a)"
          cx={15.5}
          cy={7}
          rx={1}
          ry={1.5}
        ...
        <path
          ...
          fill="url(#VG_svg_prefix__a)"
        />
        <path fill="url(#VG_svg_prefix__e)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
      </g>
    </svg>
  );
};
