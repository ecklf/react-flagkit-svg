  ...
  return (
    ...
    >
      ...
      >
        <g id="FK_svg_FK">
          <rect
            id="FK_svg_FlagBackground"
            fill="url(#FK_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="FK_svg_Mask-Copy"
            fill="url(#FK_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <g
            id="FK_svg_Rectangle-1105"
            transform="translate(13.000000, 4.000000)"
          >
            <mask id="FK_svg_mask-5" fill="white">
              <use xlinkHref="#path-4" />
            </mask>
            <use
              id="FK_svg_Mask"
              fill="url(#FK_svg_linearGradient-3)"
              xlinkHref="#path-4"
            />
            <path
              d="M0,3.5 L1.54164674e-17,0.509643555 C6.90218757e-18,0.228175192 0.21484375,0 0.497698784,0 L4.50230122,0 C4.77717266,0 5,0.226606369 5,0.509643555 L5,3.5 C5,6 2.5,7 2.5,7 C2.5,7 0,6 0,3.5 Z M2.64411871,6.36967641 C2.90723863,6.22057512 3.17088317,6.03602394 3.41551763,5.81585293 C4.09873109,5.20096081 4.5,4.43854989 4.5,3.5 L4.5,0.509643555 C4.5,0.500903502 0.49859763,0.5 0.49859763,0.5 C0.499242024,0.500576791 0.5,3.5 0.5,3.5 C0.5,4.43854989 0.901268907,5.20096081 1.58448237,5.81585293 C1.82911683,6.03602394 2.09276137,6.22057512 2.35588129,6.36967641 C2.40863204,6.3995685 2.45693356,6.42565326 2.5,6.44797816 C2.54306644,6.42565326 2.59136796,6.3995685 2.64411871,6.36967641 Z"
              id="FK_svg_Mask"
              fill="url(#FK_svg_linearGradient-6)"
              fillRule="nonzero"
              mask="url(#FK_svg_mask-5)"
            />
            <path
              d="M1.15820313,3.47460938 C1.07082995,3.21248986 1.2157526,3 1.49538898,3 L3.50461102,3 C3.7782068,3 3.93047714,3.20856857 3.84179687,3.47460938 L3.65820312,4.02539062 C3.57082995,4.28751014 3.36282608,4.33072281 3.13365793,4.15820312 C3.13365793,4.15820312 3.22192383,4 2.5,4 C1.77807617,4 1.86634207,4.15820312 1.86634207,4.15820312 C1.66401693,4.34697233 1.43047714,4.29143143 1.34179688,4.02539062 L1.15820313,3.47460938 Z"
              id="FK_svg_Rectangle-1243"
              fill="url(#FK_svg_linearGradient-7)"
              mask="url(#FK_svg_mask-5)"
            />
            <path
              d="M1.5,3 C1.77068398,3.05379707 2.09047303,2.5 2.5,2.5 C2.93673774,2.5 3.22586772,3.06717997 3.5,3 C3.74585626,2.93974947 4,2.26112626 4,2 C4,1.44771525 3.32842712,1 2.5,1 C1.67157288,1 1,1.44771525 1,2 C1,2.27926677 1.22312064,2.94497163 1.5,3 Z"
              id="FK_svg_Oval-223"
              fill="url(#FK_svg_linearGradient-1)"
              mask="url(#FK_svg_mask-5)"
            />
            ...
            <path
              ...
              id="FK_svg_Line-Copy-2"
              fill="url(#FK_svg_linearGradient-1)"
              fillRule="nonzero"
              mask="url(#FK_svg_mask-5)"
            />
          </g>
          <g id="FK_svg_Rectangle-36">
            <use
              fill="url(#FK_svg_linearGradient-8)"
              fillRule="evenodd"
              xlinkHref="#path-9"
            />
            <path
          ...
          <path
            ...
            id="FK_svg_Rectangle-2"
            fill="url(#FK_svg_linearGradient-1)"
          />
          <polygon
            id="FK_svg_Rectangle-36"
            fill="url(#FK_svg_linearGradient-8)"
