  ...
  return (
    ...
    >
      ...
      >
        <g id="SJ_svg_SJ">
          <rect
            id="SJ_svg_FlagBackground"
            fill="url(#SJ_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="SJ_svg_Mask-Copy"
            fill="url(#SJ_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
