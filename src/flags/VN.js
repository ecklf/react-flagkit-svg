  ...
  return (
    ...
    >
      ...
      >
        <g id="VN_svg_VN">
          <rect
            id="VN_svg_FlagBackground"
            fill="url(#VN_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="VN_svg_Mask-Copy"
            fill="url(#VN_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <polygon
            id="VN_svg_Star-8"
            fill="url(#VN_svg_linearGradient-3)"
