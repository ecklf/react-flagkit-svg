  ...
  return (
    ...
    >
      ...
      >
        <g id="UM_svg_UM">
          <rect
            id="UM_svg_FlagBackground"
            fill="url(#UM_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="UM_svg_Rectangle-511"
            fill="url(#UM_svg_linearGradient-2)"
          />
          <rect
            id="UM_svg_Rectangle-511"
            fill="url(#UM_svg_linearGradient-3)"
            x={0}
            y={0}
            width={9}
            height={7}
