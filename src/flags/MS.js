  ...
  return (
    ...
    >
      ...
      >
        <g id="MS_svg_MS">
          <rect
            id="MS_svg_FlagBackground"
            fill="url(#MS_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="MS_svg_Mask-Copy"
            fill="url(#MS_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="MS_svg_Rectangle-36"
            fill="url(#MS_svg_linearGradient-3)"
          />
          <path
          ...
          />
          <g
            id="MS_svg_Rectangle-1105"
            transform="translate(13.000000, 4.000000)"
          >
            <mask id="MS_svg_mask-6" fill="white">
              <use xlinkHref="#path-5" />
            </mask>
            <use
              id="MS_svg_Combined-Shape"
              fill="url(#MS_svg_linearGradient-4)"
              xlinkHref="#path-5"
            />
            <polygon
              id="MS_svg_Rectangle-1106"
              fill="#A63D09"
              mask="url(#MS_svg_mask-6)"
            ...
            <path
              ...
              id="MS_svg_Rectangle-1106"
              fill="url(#MS_svg_linearGradient-7)"
              mask="url(#MS_svg_mask-6)"
            />
          </g>
        </g>
