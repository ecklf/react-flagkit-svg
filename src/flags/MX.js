  ...
  return (
    ...
    >
      ...
      >
        <g id="MX_svg_MX">
          <rect
            id="MX_svg_FlagBackground"
            fill="url(#MX_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="MX_svg_Mask"
            fill="url(#MX_svg_linearGradient-2)"
            x={10}
            y={0}
            width={11}
            height={15}
          />
          <rect
            id="MX_svg_Rectangle-2"
            fill="url(#MX_svg_linearGradient-3)"
            x={0}
            y={0}
            width={7}
            height={15}
