...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CC_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CC_svg_prefix__b">
          <stop stopColor="#229716" offset="0%" />
          <stop stopColor="#1C7E12" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CC_svg_prefix__c">
          <stop stopColor="#FFE244" offset="0%" />
          <stop stopColor="#FFDF32" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#CC_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#CC_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
