  ...
  return (
    ...
    >
      ...
      >
        <g id="US_svg_US">
          <rect
            id="US_svg_FlagBackground"
            fill="url(#US_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="US_svg_Rectangle-511"
            fill="url(#US_svg_linearGradient-2)"
          />
          <rect
            id="US_svg_Rectangle-511"
            fill="url(#US_svg_linearGradient-3)"
            x={0}
            y={0}
            width={9}
            height={7}
