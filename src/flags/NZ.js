  ...
  return (
    ...
    >
      ...
      >
        <g id="NZ_svg_NZ">
          <rect
            id="NZ_svg_FlagBackground"
            fill="url(#NZ_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="NZ_svg_Mask-Copy"
            fill="url(#NZ_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="NZ_svg_Rectangle-36"
            fill="url(#NZ_svg_linearGradient-3)"
          />
          <path
