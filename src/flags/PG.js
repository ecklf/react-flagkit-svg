  ...
  return (
    ...
    >
      ...
      >
        <g id="PG_svg_PG">
          <rect
            id="PG_svg_FlagBackground"
            fill="url(#PG_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="PG_svg_Mask-Copy"
            fill="url(#PG_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
