  ...
  return (
    ...
    >
      ...
      >
        <g id="BZ_svg_BZ">
          <rect
            id="BZ_svg_FlagBackground"
            fill="url(#BZ_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <rect
            id="BZ_svg_Rectangle-2-Copy-4"
            fill="url(#BZ_svg_linearGradient-2)"
            x={0}
            y={2}
            width={21}
            height={11}
          />
          <rect
            id="BZ_svg_Rectangle-2"
            fill="url(#BZ_svg_linearGradient-3)"
            x={0}
            y={0}
            width={21}
            height={2}
