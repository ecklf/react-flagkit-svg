  ...
  return (
    ...
    >
      ...
      >
        <g id="AZ_svg_AZ">
          <rect
            id="AZ_svg_FlagBackground"
            fill="url(#AZ_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <rect
            id="AZ_svg_Rectangle-2"
            fill="url(#AZ_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={5}
          ...
          <rect
            id="AZ_svg_Rectangle-2"
            fill="url(#AZ_svg_linearGradient-3)"
            x={0}
            y={5}
            width={21}
            height={5}
          ...
          <rect
            id="AZ_svg_Rectangle-2"
            fill="url(#AZ_svg_linearGradient-4)"
            x={0}
            y={10}
            width={21}
            height={5}
