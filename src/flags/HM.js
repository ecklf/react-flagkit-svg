  ...
  return (
    ...
    >
      ...
      >
        <g id="HM_svg_HM">
          <rect
            id="HM_svg_FlagBackground"
            fill="url(#HM_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="HM_svg_Mask-Copy"
            fill="url(#HM_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="HM_svg_Rectangle-36"
            fill="url(#HM_svg_linearGradient-3)"
          />
          <path
