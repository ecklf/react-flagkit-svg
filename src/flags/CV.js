  ...
  return (
    ...
    >
      ...
      >
        <g id="CV_svg_CV">
          <rect
            id="CV_svg_FlagBackground"
            fill="url(#CV_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <rect
            id="CV_svg_Rectangle-2"
            fill="url(#CV_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={8}
          ...
          />
          <rect
            id="CV_svg_Rectangle-2-Copy-4"
            fill="url(#CV_svg_linearGradient-3)"
            x={0}
            y={9}
            width={21}
            height={1}
