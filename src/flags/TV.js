  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#TV_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#TV_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
          ...
          fill="#FFCD2F"
        />
        <path fill="url(#TV_svg_prefix__c)" d="M0 0h9v7H0z" />
        <path
        ...
        <path
          ...
          fill="url(#TV_svg_prefix__a)"
        />
        <path fill="url(#TV_svg_prefix__d)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
      </g>
    </svg>
  );
};
