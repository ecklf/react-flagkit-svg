  ...
  return (
    ...
    >
      ...
      >
        <g id="LK_svg_LK">
          <rect
            id="LK_svg_FlagBackground"
            fill="url(#LK_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="LK_svg_Mask-Copy"
            fill="url(#LK_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          />
          <path
            d="M8,1 L19.2493463,1 C19.6639209,1 20,1.33441405 20,1.75512566 L20,13.2448743 C20,13.6619187 19.6665269,14 19.2493463,14 L8,14 L8,1 Z"
            id="LK_svg_Rectangle-1568"
            fill="url(#LK_svg_linearGradient-3)"
          />
          <path
            d="M1,1.75512566 C1,1.33808127 1.34413815,1 1.75702667,1 L4,1 L4,14 L1.75702667,14 C1.33893239,14 1,13.665586 1,13.2448743 L1,1.75512566 Z"
            id="LK_svg_Rectangle-1568"
            fill="url(#LK_svg_linearGradient-4)"
          />
          <rect
            id="LK_svg_Rectangle-1568"
            fill="url(#LK_svg_linearGradient-5)"
            x={4}
            y={1}
            width={3}
            height={13}
