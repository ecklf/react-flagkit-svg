  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#FK_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#FK_svg_prefix__b)" d="M0 0h21v15H0z" />
        <g transform="translate(13 4)">
          <mask id="FK_svg_prefix__f" fill="#fff">
            <use xlinkHref="#FK_svg_prefix__c" />
          </mask>
          <use fill="url(#FK_svg_prefix__d)" xlinkHref="#FK_svg_prefix__c" />
          <path
            ...
            fill="url(#FK_svg_prefix__e)"
            fillRule="nonzero"
            mask="url(#FK_svg_prefix__f)"
          />
          <path
        ...
        <use fill="url(#FK_svg_prefix__h)" xlinkHref="#FK_svg_prefix__i" />
        <path
          stroke="#FFF"
          strokeWidth={0.5}
        ...
        <path
          ...
          fill="url(#FK_svg_prefix__a)"
        />
        <path fill="url(#FK_svg_prefix__h)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
      </g>
    </svg>
  );
};
