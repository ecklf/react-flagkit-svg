...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CV_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CV_svg_prefix__b">
          <stop stopColor="#0C49AE" offset="0%" />
          <stop stopColor="#063B91" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="CV_svg_prefix__c">
          <stop stopColor="#CD232E" offset="0%" />
          <stop stopColor="#CD232E" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#CV_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#CV_svg_prefix__b)" d="M0 0h21v8H0zM0 11h21v4H0z" />
        <path fill="url(#CV_svg_prefix__a)" d="M0 8h21v3H0z" />
        <path fill="url(#CV_svg_prefix__c)" d="M0 9h21v1H0z" />
        <path
