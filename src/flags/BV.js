  ...
  return (
    ...
    >
      ...
      >
        <g id="BV_svg_BV">
          <rect
            id="BV_svg_FlagBackground"
            fill="url(#BV_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="BV_svg_Mask-Copy"
            fill="url(#BV_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
