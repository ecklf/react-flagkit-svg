  ...
  return (
    ...
    >
      ...
      >
        <g id="CK_svg_CK">
          <rect
            id="CK_svg_FlagBackground"
            fill="url(#CK_svg_linearGradient-1)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <rect
            id="CK_svg_Mask-Copy"
            fill="url(#CK_svg_linearGradient-2)"
            x={0}
            y={0}
            width={21}
            height={15}
          ...
          <path
            ...
            id="CK_svg_Rectangle-36"
            fill="url(#CK_svg_linearGradient-3)"
          />
          <path
