  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#KY_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#KY_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
        ...
        <path
          ...
          fill="url(#KY_svg_prefix__a)"
        />
        <path fill="url(#KY_svg_prefix__c)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
        <ellipse fill="#FAD051" cx={15.5} cy={4} rx={1.5} ry={1} />
        <g transform="translate(13 4)">
          <mask id="KY_svg_prefix__e" fill="#fff">
            <use xlinkHref="#KY_svg_prefix__d" />
          </mask>
          <use fill="url(#KY_svg_prefix__a)" xlinkHref="#KY_svg_prefix__d" />
          <path fill="#CF142C" mask="url(#KY_svg_prefix__e)" d="M0 0h5v1H0z" />
          <path
            d="M0 6h5v1H0V6zm0-2h5v1H0V4zm0-2h5v1H0V2z"
            fill="url(#KY_svg_prefix__f)"
            mask="url(#KY_svg_prefix__e)"
          />
        </g>
      </g>
    </svg>
