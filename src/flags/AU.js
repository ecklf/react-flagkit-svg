...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="AU_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="AU_svg_prefix__b">
          <stop stopColor="#0A17A7" offset="0%" />
          <stop stopColor="#030E88" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="AU_svg_prefix__c">
          <stop stopColor="#DB1E36" offset="0%" />
          <stop stopColor="#D51931" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#AU_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#AU_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
        ...
        <path
          ...
          fill="url(#AU_svg_prefix__a)"
        />
        <path fill="url(#AU_svg_prefix__c)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
        <path
          fill="#FFF"
