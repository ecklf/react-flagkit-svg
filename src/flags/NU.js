  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#NU_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#NU_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path fill="url(#NU_svg_prefix__c)" d="M0 0h9v7H0z" />
        <path
        ...
        <path
          ...
          fill="url(#NU_svg_prefix__a)"
        />
        <path fill="url(#NU_svg_prefix__d)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
        <circle fill="url(#NU_svg_prefix__c)" cx={4.5} cy={3.5} r={1} />
        <path
