...
const SvgComponent = ({ size, width, height, ...otherProps }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="DZ_svg_prefix__a">
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#F0F0F0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="DZ_svg_prefix__b">
          <stop stopColor="#048345" offset="0%" />
          <stop stopColor="#04753E" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="DZ_svg_prefix__c">
          <stop stopColor="#E81B42" offset="0%" />
          <stop stopColor="#D20F34" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#DZ_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#DZ_svg_prefix__b)" d="M0 0h11v15H0z" />
        <path fill="url(#DZ_svg_prefix__a)" d="M11 0h10v15H11z" />
        <path
          fill="url(#DZ_svg_prefix__c)"
