  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#TC_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#TC_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
          d="M13 7.5V5c0-.553.444-1 1-1h3c.552 0 1 .441 1 1v2.5c0 2.5-2.5 3.5-2.5 3.5S13 10 13 7.5z"
          fill="url(#TC_svg_prefix__a)"
          fillRule="nonzero"
        />
        <path
          d="M15.644 10.37c.263-.15.527-.334.772-.554C17.099 9.2 17.5 8.439 17.5 7.5V5c0-.28-.221-.5-.5-.5h-3c-.279 0-.5.222-.5.5v2.5c0 .939.401 1.701 1.084 2.316a4.398 4.398 0 00.916.632c.043-.022.091-.048.144-.078z"
          fill="url(#TC_svg_prefix__c)"
          fillRule="nonzero"
        />
        ...
        <path
          ...
          fill="url(#TC_svg_prefix__a)"
        />
        <path fill="url(#TC_svg_prefix__d)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
      </g>
    </svg>
  );
};
