  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#LK_svg_prefix__a)" d="M0 0h21v15H0z" />
        <path fill="url(#LK_svg_prefix__b)" d="M0 0h21v15H0z" />
        <path
          d="M8 1h11.25a.75.75 0 01.75.755v11.49a.751.751 0 01-.75.755H8V1z"
          fill="url(#LK_svg_prefix__c)"
        />
        <path
          d="M1 1.755A.76.76 0 011.757 1H4v13H1.757A.754.754 0 011 13.245V1.755z"
          fill="url(#LK_svg_prefix__d)"
        />
        <rect
          fill="url(#LK_svg_prefix__e)"
          x={4}
          y={1}
          width={3}
          height={13}
